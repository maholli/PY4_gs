...
from rpi_radio_helpers import radio1, cfg, rpi_rx_fast  # radio setup and config
...
GROUND_STATION_ID = "W5MAH" # Letters and numbers only. No spaces
# constants
